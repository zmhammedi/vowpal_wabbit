...
vw_status predict(vw_workspace* vw, vw_prediction** prediction, vw_example* example);
vw_status predict(vw_workspace* vw, vw_prediction** predictions, vw_example* example, int len);
