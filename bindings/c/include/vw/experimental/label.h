...
extern "C"
{
  ...
  VW_DLL_PUBLIC VWStatus VWCBLabelSetWeight(VWCBLabel* cb_label_handle, float weight, VWErrorString* err_str_container) VW_API_NOEXCEPT;
  ...
  VW_DLL_PUBLIC VWStatus VWCCBLabelGetCost(VWCCBLabel* ccb_label_handle, float* cost, VWErrorString* err_str_container) VW_API_NOEXCEPT;
  VW_DLL_PUBLIC VWStatus VWCCBLabelSetCost(VWCCBLabel* ccb_label_handle, float cost, VWErrorString* err_str_container) VW_API_NOEXCEPT;
