...
extern "C"
{
  ...
  VW_DLL_PUBLIC VWStatus vw_destroy_example_array_holder(
      VWExampleArrayHolder* example_array_holder_handle, VWErrorInfo* err_info_container) VW_API_NOEXCEPT;
  ...
  VW_DLL_PUBLIC VWStatus vw_parse_example(VWWorkspace* workspace_handle, /*const*/ uint8_t* data, size_t length,
      ...
      size_t* num_examples_produced, VWExampleFactoryFunc* factory, VWErrorInfo* err_info_container) VW_API_NOEXCEPT;
